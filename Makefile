...
# E  = Email
DNAME_CA='CN=Aim CA,OU=aimmanager.com,O=Aim,L=Santiago,ST=Santiago,C=CC'
# For server certificates, the Common Name (CN) must be the hostname
DNAME_HOST='CN=$(HOSTNAME),OU=aimmanager.com,O=Aim,L=Santiago,ST=Santiago,C=CL'
DNAME_CLIENT='CN=$(CLIENTNAME),OU=aimmanager.com,O=Aim,L=Santiago,ST=Santiago,C=CL'
